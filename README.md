...
In the above picture, you can see the beginning of the simulation the dev ended up making. The blue blobs are prey, the red are predators, the green are food (for the prey), and the brown are statioanry obstacles. In the top left is a counter for how many predators are currently in the simualtion (alive), and in the top right corner is a counter for prey. The dev's simulation including those agents and objects, predator-predator fighting and mating, prey-prey mating, predator-prey damaging, hunting, and eating, prey-food eating, food regeneration, and some slight prey memory of where food is.
